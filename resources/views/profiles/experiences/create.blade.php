        ...
        <div>
            ...
            <form action="/education" method="POST">
                ...
                <div class="form-group">
                    ...
                    <label for="school">Companu</label>

                    <input type="text" name="company" class="form-control" placeholder="Enter company" value="{{ old('company') }}" id="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="podiydion" class="form-control" placeholder="Enter program of Study" value="{{ old('program') }}" id="">
                ...
                <div class="form-group">
                    ...
                    <input type="month" required class="form-control" name="start_date" value="{{ old('start_date') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="month" class="form-control" name="completion_date" value="{{ old('completion_date') }}">
